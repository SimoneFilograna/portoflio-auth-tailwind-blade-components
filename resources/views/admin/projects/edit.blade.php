    ...
    <div class="container mx-auto mt-20 flex justify-center">
        <form action="{{route('admin.projects.update', $project->slug)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="title" name="title" class="w-full" value="{{old("title", $project->title)}}">
                @error("title")
            ...
            <div class="mb-3 mt-2">
                ...
                <div class="flex">
                    ...
                    <div class="">
                        <input class="" type="checkbox" value="{{$singleTech->id}}" {{$project->technologies?->contains($singleTech->id) ? "checked" : ""}} id="flexCheckDefault" name="technologies[]">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="link" name="link" class="w-full" value="{{old("title", $project->link)}}">
                @error("link")
                    <div class="">{{$message}}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea  id="description" name="description" class="w-full">{{old("description", $project->description)}}</textarea>
                @error("description")
                    <div class="">{{$message}}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" id="date" name="release"  class="w-full" value="{{old("release", $project->release->format("Y-m-d"))}}">
                @error("release")
                    <div class="">{{$message}}</div>
                @enderror
            </div>
